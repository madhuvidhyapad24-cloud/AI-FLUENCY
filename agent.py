...
if __name__ == "__main__":
    ...
    print("Q:", "I can pay Rs. 30,000. Which two courses can I take together within this budget?")
    print("A:", agent("I can pay Rs. 30,000. Which two courses can I take together within this budget?"))        
